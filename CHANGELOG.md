...
**Hedef register:** Resmi-temiz / siz dili. Saygı tonu korunur, bürokratik şişkinlik atılır.

**Türkçeye özgü eklenenler**

- Resmi şişkinlik ekleri: `-mektedir/-maktadır`, `-dir` kopulası (önemlidir, gereklidir), aşırı edilgen (yapılmaktadır, görülmektedir)
...
- `-dir` kopulası tanım ve genelgeçer olgularda serbest bırakıldı

**Dosyalar:** SKILL.md, referanslar/ifadeler.md, referanslar/yapilar.md, referanslar/ornekler.md (6 sıfırdan Türkçe örnek)
